...
/*        RetrofitRequestManager.getInstance().getAPI().
    ...
    @OnClick({R.id.btn_get, R.id.btn_post, R.id.btn_netimage, R.id.btn_rxget, R.id.btn_rxpost, 
            R.id.btn_switch_baseurl, R.id.btn_dimens, R.id.btn_resolution_test})
...
//                                  Log.d("cg", "onResponse postData else: " + response.headers().toString());
            ...
            case R.id.btn_netimage:
                Intent intent = new Intent(MainActivityOld.this, NetImageActivity.class);
            ...
            case R.id.btn_resolution_test:
                Intent intentResolutionTest = new Intent(MainActivityOld.this, ResolutionTestActivity.class);
